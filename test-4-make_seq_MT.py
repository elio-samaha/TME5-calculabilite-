...
assert b1==True, "Erreur dans le langage accepte"
assert L1==["a","b","D","Z"], "Erreur dans la bande a la fin du calcul"
assert i1==1, "Erreur dans la position de la tete de lecture"
(b1,i1,L1)=exec_MT_1(M1,["Z"],0)
assert b1==False, "Erreur dans le langage accepte"
